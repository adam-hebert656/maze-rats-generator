defmodule MausgenWeb.CoreComponents do
  @moduledoc """
  ...
  def translate_error({msg, opts}) do
    ...
    if count = opts[:count] do
      Gettext.dngettext(MausgenWeb.Gettext, "errors", msg, msg, count, opts)
    else
      Gettext.dgettext(MausgenWeb.Gettext, "errors", msg, opts)
    end
  end
